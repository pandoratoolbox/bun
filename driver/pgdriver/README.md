...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/pandoratoolbox/bun/driver/pgdriver)](https://pkg.go.dev/github.com/pandoratoolbox/bun/driver/pgdriver)
...
```shell
go get github.com/pandoratoolbox/bun/driver/pgdriver
```

And then create a `sql.DB` using it:

```go
import _ "github.com/pandoratoolbox/bun/driver/pgdriver"
